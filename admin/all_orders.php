...
?>
                ...
                <body class="fix-header fix-sidebar" style="background-color: yellow;">
                    ...
                    <div id="main-wrapper">
                            ...
                            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                                <div class="navbar-collapse">
                                    ...
                                    <ul class="navbar-nav my-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="admin/images/bookingSystem/useicn.png" alt="LogOut" class="profile-pic" /></a>
                            ...
                            <div class="scroll-sidebar">
                                ...
                                <nav class="sidebar-nav">
                                    <ul id="sidebarnav">
                                        ...
                                        <li> <a href="all_users.php"> <span><i class="fa fa-user f-s-20 "></i></span><span>Customers Details</span></a></li>
                                        <!-- <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Bakery</span></a> -->
                                            <ul aria-expanded="false" class="collapse">
                                                <!-- <li><a href="all_restaurant.php">Bakery</a></li>
                                                <li><a href="add_category.php">Add Category</a></li>
                                                <li><a href="add_restaurant.php">Add Bakery</a></li> -->
                        ...
                        <div class="page-wrapper">
                            <div style="padding-top: 10px;">
                                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <h3><a>Delicious Bakery 🎂</a></h3></marquee>
                            </div>
