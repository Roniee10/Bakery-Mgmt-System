    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-black">
                <h1>Delighted to have your company with us.</h1>
                ...
                <!-- <div class="steps">
                    <div class="step-item step1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 483 483" width="700" height="512">
                            <g fill="#FFF">
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-4 col-md-3 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">RS'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-block pull-right" style="border:1px solid">Order Now</a> </div>
                                                </div>
