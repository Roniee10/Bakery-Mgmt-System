                    ...
                    <div id="main-wrapper">
                                    ...
                                    <ul id="sidebarnav">
                                        ...
                                        <!-- <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Bakery 🎂</span></a> -->
                                            <ul aria-expanded="false" class="collapse">
                                                ...
                                                <li><a href="add_restaurant.php">Bakery 🎂</a></li> -->
                        ...
                        <div class="page-wrapper">
                            <div style="padding-top: 10px;">
                                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a>Bakery 🎂</a></marquee>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        <div class="card-header">
                                            <!-- <h4 class="m-b-0 text-white">Add Bakery</h4> -->
                                        </div>
                                        <div class="card-body">
                                            <form action='' method='post' enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Bakery 🎂</label>
                                                    ...
                                                    <h3 class="box-title m-t-40">Bakery location</h3>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
