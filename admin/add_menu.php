                            ...
                            <div class="scroll-sidebar ">
                                ...
                                <nav class="sidebar-nav">
                                    <ul id="sidebarnav">
                                        ...
                                        <!-- <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">.</span></a> -->
                                            <ul aria-expanded="false" class="collapse">
                                                <!-- <li><a href="all_restaurant.php">Restaurant</a></li>
