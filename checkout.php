                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Bakery 🎂<span class="sr-only"></span></a> </li>
						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
										...
										echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active">My Items</a> </li>';
                                            ...
                                            <ul class=" list-unstyled">
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-10">
                                                        <input name="mod" type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Paypal <a href="https://www.paypal.com/np/home">
    <img src="images/Paypal.png" alt="Paypal">
</a></span> </label>
                                                </li>
                                            </ul>
                                            <p class="text-xs-center"> <input type="submit" onclick="return confirm('Do you want to confirm the order');" name="submit" class="btn btn-success btn-block" value="Buy Now"> </p>
                                        </div>
                            </form>
                        </div>
                    </div>
